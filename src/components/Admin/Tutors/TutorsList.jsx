...
import { getTutorsList } from '../../../Services/adminApi';
...
function TutorsList() {
  ...
  return (
    <div className="h-screen w-full bg-[#141B2D]">
      <NavBar />
      <h1 className="text-3xl mx-5 uppercase  text-white font-bold tracking-widest">Tutors List</h1>
      ...
      <label htmlFor="table-search" className="sr-only">Search</label>
        <div className="relative ">
            ...
            <input type="text" id="table-search-users" className="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for tutors"/>
        </div>
      </div>
            ...
            {tutorData.map((user, index) => {
              return (
                <tr key={index} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <td className="px-6 py-4">
                    <button
                      className="bg-[#3DA58A] w-28  text-center py-2 rounded-xl  font-semibold font-mono  text-white">
                      Active
                    </button>
                  </td>
                </tr>
