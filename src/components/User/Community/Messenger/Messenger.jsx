...
import { getjoinedGroups, sendMessage } from '../../../../Services/userApi';
                                        ...
                                        <div className="flex flex-row items-center p-4">
                                            ...
                                            <button type="button" className="flex flex-shrink-0 focus:outline-none mx-2  text-blue-600 hover:text-blue-700 w-6 h-6">
                                                <div className=" text-xs absolute   font-bold  rounded-full w-10 h-10  text-white flex justify-center items-center   float-left   overflow-hidden cursor-pointer">
                                                    <input type="file" name="photo" className="absolute inset-0  opacity-0 cursor-pointer" onChange={(e) => { setImage(e.target.files[0]) }} />
                                                </div>
                                                <IoImage size={22} />
                                            </button>
